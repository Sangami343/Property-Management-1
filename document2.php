...
$userID = $_SESSION['id']; // Logged user ID
...
header { top: 0; font-size: 10px; font-weight: bold; }
footer { bottom: 0; font-size: 10px; font-weight: bold; }
        ...
        if (xhr.readyState == 4) {
            if (xhr.status == 200) {
                ...
                window.location.href =
                    'view6.php?unitID=' + encodeURIComponent(unitID) +
